# -*- coding: utf-8 -*-
"""Import batch 4 investors to Supabase"""
import os
from dotenv import load_dotenv
from supabase import create_client, Client
from investors_batch4 import INVESTORS_BATCH4
...
def run():
    print(f"\n>>> Importing {len(INVESTORS_BATCH4)} investors (batch 4)...\n")
    ok, skip, err = 0, 0, 0
    for inv in tqdm(INVESTORS_BATCH4, desc="Uploading"):
        try:
