# -*- coding: utf-8 -*-
"""
Import extended 500+ investor dataset to Supabase
"""
import os
from dotenv import load_dotenv
from supabase import create_client, Client
from investors_500 import INVESTORS_500
...
def run():
    print(f"\n>>> Importing {len(INVESTORS_500)} investors...\n")
    ok, skip, err = 0, 0, 0
    for inv in tqdm(INVESTORS_500, desc="Uploading"):
        try:
