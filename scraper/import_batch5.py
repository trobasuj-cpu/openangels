# -*- coding: utf-8 -*-
"""Import batch 5 investors to Supabase"""
import os
from dotenv import load_dotenv
from supabase import create_client, Client
from investors_batch5 import INVESTORS_BATCH5
...
def run():
    print(f"\n>>> Importing {len(INVESTORS_BATCH5)} investors (batch 5 - FINAL)...\n")
    ok, skip, err = 0, 0, 0
    for inv in tqdm(INVESTORS_BATCH5, desc="Uploading"):
        try:
