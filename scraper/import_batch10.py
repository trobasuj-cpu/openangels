...
from investors_batch10 import INVESTORS_BATCH10
...
def run():
    print(f"\n>>> Importing {len(INVESTORS_BATCH10)} investors (BATCH 10 - FINAL)...\n")
    ok, skip, err = 0, 0, 0
    for inv in tqdm(INVESTORS_BATCH10, desc="Uploading"):
        try:
    ...
    if res.count >= 1000:
        print(">>> 1000+ INVESTORS - READY FOR PRODUCT HUNT LAUNCH!")
    else:
