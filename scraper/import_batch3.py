# -*- coding: utf-8 -*-
"""Import batch 3 investors to Supabase"""
import os
from dotenv import load_dotenv
from supabase import create_client, Client
from investors_batch3 import INVESTORS_BATCH3
...
def run():
    print(f"\n>>> Importing {len(INVESTORS_BATCH3)} investors (batch 3)...\n")
    ok, skip, err = 0, 0, 0
    for inv in tqdm(INVESTORS_BATCH3, desc="Uploading"):
        try:
